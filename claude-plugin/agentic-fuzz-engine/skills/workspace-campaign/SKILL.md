...
ad-hoc agents outside the plugin. The division of labor follows Atlantis:
agents AUTHOR artifacts (specs, dictionaries, seed-generator scripts,
harnesses); the engine EXECUTES them at scale under resource guards.
